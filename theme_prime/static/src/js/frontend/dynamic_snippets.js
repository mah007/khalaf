...
publicWidget.registry.s_d_single_product_count_down = ProductRootWidget.extend(ProductsBlockMixins, {
    ...
    _modifyElementsAfterAppend: function () {
        ...
        this.$('.droggol_product_slider_single_product').owlCarousel({ dots: false, margin: 20, rtl: localization === 'rtl', stagePadding: 5, rewind: true, nav: true, navText: ['<i class="dri dri-arrow-left-l"></i>', '<i class="dri dri-arrow-right-l"></i>'], responsive: {0: {items: 1,},}});
    },
});
...
publicWidget.registry.s_single_category_snippet = ProductRootWidget.extend(CategoryPublicWidgetMixins, MarkupRecords, {
    ...
    initializeOwlSlider: function () {
        this.$('.droggol_product_category_slider').owlCarousel({ dots: false, margin: 10, stagePadding: 5, rtl: localization === 'rtl', rewind: true, nav: true, navText: ['<div class="badge text-primary"><i class="dri font-weight-bold dri-chevron-left-l"></i></div>', '<div class="badge text-primary"><i class="dri dri-chevron-right-l font-weight-bold"></i></div>'], responsive: {0: {items: 1}, 576: {items: 1}, 768: {items: 1}, 992: {items: 1}, 1200: {items: 1}}});
    }
});
...
publicWidget.registry.s_d_product_small_block = ProductRootWidget.extend(ProductsBlockMixins, {
    ...
    _modifyElementsAfterAppend: function () {
        ...
        this.$('.droggol_product_slider_top').owlCarousel({ dots: false, margin: 20, stagePadding: this.inConfirmDialog ? 0 : 5, rewind: true, nav: true, rtl: localization === 'rtl', navText: ['<i class="dri h4 dri-chevron-left-l"></i>', '<i class="dri h4 dri-chevron-right-l"></i>'],
...
publicWidget.registry.s_d_image_products_block = ProductRootWidget.extend(ProductsBlockMixins, MarkupRecords, {
    ...
    _modifyElementsAfterAppend: function () {
        this._super.apply(this, arguments);
        this.$('.droggol_product_slider_top').owlCarousel({ dots: false, margin: 10, stagePadding: 5, rewind: true, nav: true, rtl: localization === 'rtl', navText: ['<i class="dri h4 dri-chevron-left-l"></i>', '<i class="dri h4 dri-chevron-right-l"></i>'], responsive: {0: {items: 1}, 576: {items: 1}, 768: {items: 1}, 992: {items: 1}, 1200: {items: 1}},
        });
    },
});
...
publicWidget.registry.s_d_brand_snippet = RootWidget.extend({
    ...
    _modifyElementsAfterAppend: function () {
        ...
        if (this.mode === 'slider') {
            ...
            this.$('.owl-carousel').owlCarousel({ nav: false, dots: false, autoplay: true, autoplayTimeout: 4000, rtl: localization === 'rtl', responsive: {0: {items: 2}, 576: {items: 4}}});
        }
    },
});
