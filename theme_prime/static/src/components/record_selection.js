...
export class TpRecordSelector extends AbstractComponent {
    ...
    get nodeOptions() {
        return { TpSearchInput: { defaultParams: { ... this.defaultParams }, recordsIDs: this.recordsIDs, fieldsToMarkup: this.fieldsToMarkup, brand: this.isBrand, hasSuggestion: this.SelectionMode !== 'badge'}, selectionType: { buttonClasses: 'btn d-flex justify-content-between align-items-center btn-default bg-white border shadow-sm fw-light w-100 btn-sm', records: [{ id: 'manual', iconClass: 'fa fa-hand-pointer-o', title: _t("Manual") }, { id: 'advance', iconClass: 'fa fa-sliders', title: _t("Advance") }]}};
    }
    // Override
